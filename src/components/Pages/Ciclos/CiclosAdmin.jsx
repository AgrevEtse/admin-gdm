    ...
    <div className='mt-10 flex h-full flex-col items-center justify-center space-y-6'>
      ...
      <div className='flex w-full flex-col justify-center space-y-6 px-4 md:flex-row md:space-y-0 md:space-x-6'>
        {isLoading ? (
          ...
          <>
            <div className='card w-xs border bg-emerald-300 text-emerald-950'>
            ...
            <div className='card w-xs border bg-red-300 text-red-950'>
              <div className='card-body'>
      ...
      <div className='flex w-full flex-col space-y-6 px-4 md:flex-row md:space-y-0 md:space-x-6'>
        {isLoading ? (
          ...
          <>
            <div className='card border bg-emerald-300 text-emerald-950'>
            ...
            <div className='card border bg-red-300 text-red-950'>
              <div className='card-body space-y-2'>
      ...
      <div className='flex w-full flex-col space-y-6 px-4 md:flex-row md:space-y-0 md:space-x-6'>
        {isLoading ? (
          ...
          <div className='card bg-neutral-content text-neutral w-full border'>
            <div className='card-body'>
